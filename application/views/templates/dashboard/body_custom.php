...
<body>
	...
	<div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
		<?php
		$include_topbar = isset($include_topbar) ? $include_topbar : true;
		$include_sidebar = isset($include_sidebar) ? $include_sidebar : true;
		if ($include_topbar) { ?>
			<div class="app-header header-shadow">
				<div class="app-header__logo">
					...
					<div class="header__pane ml-auto" <?php echo (!$include_sidebar) ? 'hidden' : '' ?>>
						<div>
				...
				<div class="app-header__mobile-menu" <?php echo (!$include_sidebar) ? 'hidden' : '' ?>>
					<div>
				...
				<div class="app-header__content">
					<div hidden class="app-header-left">
						<div class="search-wrapper" <?php echo (!$include_sidebar) ? 'hidden' : '' ?>>
					...
					<div class="app-header-right">
						<div class="header-dots" <?php echo (!$include_sidebar) ? 'hidden' : '' ?>>
							<div class="dropdown">
								<button type="button" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown" class="p-0 mr-2 btn btn-link">
									<span class="icon-wrapper icon-wrapper-alt rounded-circle">
										<span class="icon-wrapper-bg bg-danger"></span>
										<i id="notification_header_anim" class="icon text-danger icon-anim-pulse ion-android-notifications"></i>
								...
								<div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
									...
									<ul class="nav flex-column">
										...
										<li class="nav-item-btn text-center nav-item">
											<button class="btn-shadow btn-wide btn-pill btn btn-focus btn-sm">Selengkapnya...</button>
										</li>
									</ul>
								</div>
							</div>
									...
									<div class="widget-content-left">
										<div class="btn-group">
											...
											<div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-292px, 44px, 0px);">
												...
												<div class="scroll-area-xs" style="height: 150px;" <?php echo (!$include_sidebar) ? 'hidden' : '' ?>>
													<div class="scrollbar-container ps">
														<ul class="nav flex-column">
												...
												<div class="grid-menu grid-menu-2col">
													<div class="no-gutters row">
														<div class="col-sm-6" <?php echo (!$include_sidebar) ? 'hidden' : '' ?>>
														...
														<div class="col-sm-<?php echo (!$include_sidebar) ? '12' : '6' ?>">
		...
		<div class="app-main">
			...
			<?php } ?>
			<div class="<?php echo ($include_sidebar) ? 'app-main__outer' : 'app-main__outer' ?>" style="padding-left:0px !important;">
...
<!-- Large modal -->
<div id="modal-large" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-large modal-lg">
		<div class="modal-content modal-content-large">
			...
			<div id="modal-body" class="modal-body modal-body-large">
			</div>
...
<div class="modal fade" id="modal-basic" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modal-title-basic"></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body" id="modal-body-basic">
			</div>
			<div class="modal-footer" id="modal-footer-basic">
			</div>
		</div>
	</div>
</div>