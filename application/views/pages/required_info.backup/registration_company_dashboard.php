        ...
        <div class="card-body">
            <div id="form-fields">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="highest_project_value" class="form-control input-mask-trigger" placeholder="Ex: 1000000000" name="highest_project_value" data-validation="required" data-inputmask-regex="^[0-9]{1,1000}$" inputmode="verbatim" data-validation-error-msg="Nilai Proyek Tertinggi tidak valid!">
                    </div>
                </div>
                <!-- Company Profile -->
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="email_pic" class="form-control" placeholder="Ex: example@bgrindonesia.co.id" name="email_pic" data-validation="required email" data-validation-error-msg="Email PIC tidak valid!">
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input is-mandatory="true" type="file" id="attachment_nib" name="attachment_nib" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
