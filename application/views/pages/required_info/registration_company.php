            ...
            <div id="form-fields">
                <div class="form-group row">
                    ...
                    <div class="col-md-<?php echo ($this->session->userdata('user')['id_usr_role'] == App_Model::ROLE_VENDOR_PERSONAL ? '5' : '8') ?>">
                        <input maxlength="40" v-model="form.name.val" data-validation="required" data-validation-error-msg="Nama Perusahaan tidak valid!." type="text" name="name" id="name" placeholder="<?php echo ($this->session->userdata('user')['id_usr_role'] == App_Model::ROLE_VENDOR_PERSONAL ? 'Nama Belakang' : 'Nama Perusahaan') ?>" id="prefix_name" class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="email" id="email" class="form-control" placeholder="Ex: info@bgrlogistik.id" name="email" data-validation="required email" data-validation-error-msg="Email Perusahaan tidak valid!">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="highest_project_value" value="0" class="form-control input-mask-trigger" placeholder="Ex: 1000000000" name="highest_project_value" data-validation="required" data-inputmask-regex="^[0-9]{1,1000}$" inputmode="verbatim" data-validation-error-msg="Nilai Proyek Tertinggi tidak valid!">
                    </div>
                </div>
                <!-- Company Profile -->
                <div class="row" style="margin-bottom:0px;">
                    ...
                    <div class="col-md-10">
                        <input is-mandatory="true" data-validation-error-msg="File Company Profile tidak valid!" type="file" id="company_profile" name="company_profile" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf,jpg,jpeg,png" />
                        <span style="color:red">File pdf, jpg, jpeg, png Maksimal 50MB</span>
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="name_pic" class="form-control" placeholder="Ex: Yudha Purnawan" name="name_pic" data-validation="required" data-validation-error-msg="Nama Lengkap PIC tidak valid!">
                </div>
            </div>
            <div class="form-group row">
                <label id="" class="col-sm-2 col-form-label">
                ...
                <div class="col-sm-10">
                    <select type="select" id="position_type" onchange="ocPositionType(this);" name="position_type" class="form-control" data-validation="required" data-validation-error-msg="Jenis posisi PIC tidak valid!">
                        <option value="">Pilih</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="position" class="form-control" placeholder="Ex: Manager Procurement" name="position" data-validation="required" data-validation-error-msg="Posisi/Jabatan tidak valid!">
                </div>
            </div>
            <div class="form-group row">
                <label id="" class="col-sm-2 col-form-label">
                ...
                <div class="col-sm-10">
                    <input type="text" id="mobile_phone" class="form-control input-mask-trigger" placeholder="Ex: 081234567899" name="mobile_phone" data-validation="required" data-inputmask-regex="^[0-9]{1,15}$" inputmode="verbatim" data-validation-error-msg="No Handphone PIC tidak valid!">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="email_pic" class="form-control" placeholder="Ex: example@bgrlogistik.id" name="email_pic" data-validation="required email" data-validation-error-msg="Email PIC tidak valid!">
                </div>
            </div>
            ...
            <div class="row" style="margin-bottom:0px;">
                ...
                <div class="col-md-10">
                    <input is-mandatory="true" type="file" id="attachment_surat_kuasa" name="attachment_surat_kuasa" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-1">
                    <label for="">Tanggal Berlaku <span class="text-danger">*</span></label>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
                        <input type="date" id="tanggal_berlaku_npwp" class="form-control" name="tanggal_berlaku_npwp" data-validation="required" data-validation-error-msg="Tanggal Berlaku NPWP wajib diisi!">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input is-mandatory="true" type="file" id="attachment_akta" name="attachment_akta" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg, zip" />
                    <span style="color:red">File pdf, png, jpeg, jpg, zip Maksimal 50MB <br /> Mohon kirim Akta Pendirian dan Pembaruan(jika ada) dalam bentuk zip</span>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <input type="date" id="tanggal_berlaku" class="form-control" name="tanggal_berlaku">
                    </div>
                </div>
            </div>
            ...
            <!-- <div class="form-group row" style="margin-top: 10px">
                <label id="" class="col-sm-2 col-form-label">
                    Tanggal Berlaku Akta Perusahaan<span style="color:red;">*</span>
                </label>
                <div class="col-sm-10">
                    <input type="date" id="tanggal_berlaku" class="form-control" name="tanggal_berlaku">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input is-mandatory="true" type="file" id="attachment_siup" name="attachment_siup" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <input type="date" id="tanggal_berlaku_siup" class="form-control" name="tanggal_berlaku_siup" data-validation="required" data-validation-error-msg="Tanggal Berlaku SIUP wajib diisi!">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-2">
                    <label for="">Upload TDP<span style="color:red;">*</span></label>
                </div>
                <div class="col-md-4">
                    <input is-mandatory="true" type="file" id="attachment_tdp" name="attachment_tdp" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <input type="date" id="tanggal_berlaku_tdp" class="form-control" name="tanggal_berlaku_tdp" data-validation="required" data-validation-error-msg="Tanggal Berlaku TDP wajib diisi!">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <input is-mandatory="false" type="file" id="attachment_nib" name="attachment_nib" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <input type="date" id="tanggal_berlaku_nib" class="form-control" name="tanggal_berlaku_nib" data-validation="required" data-validation-error-msg="Tanggal Berlaku NIB wajib diisi!">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <input type="date" id="tanggal_berlaku_tdg" class="form-control" name="tanggal_berlaku_tdg" data-validation="required" data-validation-error-msg="Tanggal Berlaku TDG wajib diisi!">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input is-mandatory="true" type="file" id="attachment_domisili" name="attachment_domisili" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" maxlength="40" id="owner" class="form-control" placeholder="Nama Nasabah" name="owner" data-validation="required length" data-validation-length="max40" data-validation-error-msg="Nama Nasabah tidak valid, maksimal 40 karakter!">
                </div>
            </div>
            <div class="form-group row">
                <label id="" class="col-sm-2 col-form-label">
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input is-mandatory="true" type="file" id="attachment_fin_report_1y" name="attachment_fin_report_1y" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
...
<script>
    ...
    $('#type').change(function() {
        ...
        if (val.includes('7')) {
            ...
            // $('#tanggal_berlaku').parent('div').parent('div').show();
            ...
            // $('#tanggal_berlaku').parent('div').parent('div').hide();
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (contact != null && Object.keys(contact).length > 0) {
                    ...
                    if(contact.tanggal_berlaku != null) {
                        const tanggal_berlaku = new Date(contact.tanggal_berlaku);
                        var selisihMilidetik = now - tanggal_berlaku;
                        var selisihHari = Math.floor(selisihMilidetik / (1000 * 60 * 60 * 24));

                        if(selisihHari >= -30 && selisihHari <= 0) {
                            $('#tanggal_berlaku').addClass('bg-warning text-white');
                        } else if(selisihHari > 0) {
                            $('#tanggal_berlaku').addClass('bg-danger text-white');
                        } else {
                            $('#tanggal_berlaku').addClass('bg-success text-white');
                        }
                    }
                    
                    if(contact.tanggal_berlaku_npwp != null) {
                        const tanggal_berlaku_npwp = new Date(contact.tanggal_berlaku_npwp);
                        var selisihMilidetik_npwp = now - tanggal_berlaku_npwp;
                        var selisihHari_npwp = Math.floor(selisihMilidetik_npwp / (1000 * 60 * 60 * 24));

                        if(selisihHari_npwp >= -30 && selisihHari_npwp <= 0) {
                            $('#tanggal_berlaku_npwp').addClass('bg-warning text-white');
                        } else if(selisihHari_npwp > 0) {
                            $('#tanggal_berlaku_npwp').addClass('bg-danger text-white');
                        } else {
                            $('#tanggal_berlaku_npwp').addClass('bg-success text-white');
                        }
                    }
                    
                    if(contact.tanggal_berlaku_siup != null) {
                        const tanggal_berlaku_siup = new Date(contact.tanggal_berlaku_siup);
                        var selisihMilidetikSiup = now - tanggal_berlaku_siup;
                        var selisihHariSiup = Math.floor(selisihMilidetikSiup / (1000 * 60 * 60 * 24));

                        if(selisihHariSiup >= -30 && selisihHariSiup <= 0) {
                            $('#tanggal_berlaku_siup').addClass('bg-warning text-white');
                        } else if(selisihHariSiup > 0) {
                            $('#tanggal_berlaku_siup').addClass('bg-danger text-white');
                        } else {
                            $('#tanggal_berlaku_siup').addClass('bg-success text-white');
                        }
                    }
                    
                    if(contact.tanggal_berlaku_tdp != null) {
                        const tanggal_berlaku_tdp = new Date(contact.tanggal_berlaku_tdp);
                        var selisihMilidetik_tdp = now - tanggal_berlaku_tdp;
                        var selisihHari_tdp = Math.floor(selisihMilidetik_tdp / (1000 * 60 * 60 * 24));

                        if(selisihHari_tdp >= -30 && selisihHari_tdp <= 0) {
                            $('#tanggal_berlaku_tdp').addClass('bg-warning text-white');
                        } else if(selisihHari_tdp > 0) {
                            $('#tanggal_berlaku_tdp').addClass('bg-danger text-white');
                        } else {
                            $('#tanggal_berlaku_tdp').addClass('bg-success text-white');
                        }
                    }
                    
                    if(contact.tanggal_berlaku_tdg != null) {
                        const tanggal_berlaku_tdg = new Date(contact.tanggal_berlaku_tdg);
                        var selisihMilidetik_tdg = now - tanggal_berlaku_tdp;
                        var selisihHari_tdg = Math.floor(selisihMilidetik_tdg / (1000 * 60 * 60 * 24));

                        if(selisihHari_tdg >= -30 && selisihHari_tdg <= 0) {
                            $('#tanggal_berlaku_tdg').addClass('bg-warning text-white');
                        } else if(selisihHari_tdg > 0) {
                            $('#tanggal_berlaku_tdg').addClass('bg-danger text-white');
                        } else {
                            $('#tanggal_berlaku_tdg').addClass('bg-success text-white');
                        }
                    }
                    
                    if(contact.tanggal_berlaku_nib != null) {
                        const tanggal_berlaku_nib = new Date(contact.tanggal_berlaku_nib);
                        var selisihMilidetik_nib = now - tanggal_berlaku_nib;
                        var selisihHari_nib = Math.floor(selisihMilidetik_nib / (1000 * 60 * 60 * 24));

                        if(selisihHari_nib >= -30 && selisihHari_nib <= 0) {
                            $('#tanggal_berlaku_nib').addClass('bg-warning text-white');
                        } else if(selisihHari_nib > 0) {
                            $('#tanggal_berlaku_nib').addClass('bg-danger text-white');
                        } else {
                            $('#tanggal_berlaku_nib').addClass('bg-success text-white');
                        }
                    }
                    ...
                    $('#tanggal_berlaku').val(contact.tanggal_berlaku);
                    $('#tanggal_berlaku_npwp').val(contact.tanggal_berlaku_npwp);
                    $('#tanggal_berlaku_siup').val(contact.tanggal_berlaku_siup);
                    $('#tanggal_berlaku_tdp').val(contact.tanggal_berlaku_tdp);
                    $('#tanggal_berlaku_tdg').val(contact.tanggal_berlaku_tdg);
                    $('#tanggal_berlaku_nib').val(contact.tanggal_berlaku_nib);
