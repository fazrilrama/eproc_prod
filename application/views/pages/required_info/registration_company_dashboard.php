...
<form id="form_input" style="padding:10px;">
    ...
    <input type="hidden" name="id_usr_role" id="id_usr_role" value="2">
    ...
    <input type="hidden" id="action_domisili" name="action_domisili" value="">
    <input type="hidden" id="action_pakta" name="action_pakta" value="">
        ...
        <div class="card-body">
            <div id="form-fields">
                <div class="form-group row">
                    ...
                    <div id="company_name_container" class="col-md-<?php echo ($this->session->userdata('user')['id_usr_role'] == App_Model::ROLE_VENDOR_PERSONAL ? '5' : '2') ?>">
                        <?php if ($this->session->userdata('user')['id_usr_role'] == App_Model::ROLE_VENDOR_PERSONAL) { ?>
                            <input maxlength="40" v-model="form.prefix_name.val" data-validation-error-msg="Prefix tidak valid!." type="text" name="prefix_name" id="prefix_name" placeholder="Nama Depan" class="form-control personal">
                        <?php } else { ?>
                            <select v-model="form.prefix_name.val" data-validation-error-msg="Prefix tidak valid!." type="text" name="prefix_name" id="prefix_name" class="form-control non_personal">
                    ...
                    <div class="col-md-<?php echo ($this->session->userdata('user')['id_usr_role'] == App_Model::ROLE_VENDOR_PERSONAL ? '5' : '8') ?>">
                        <input maxlength="40" v-model="form.name.val"  data-validation-error-msg="Nama Perusahaan tidak valid!." type="text" name="name" id="name" placeholder="<?php echo ($this->session->userdata('user')['id_usr_role'] == App_Model::ROLE_VENDOR_PERSONAL ? 'Nama Belakang' : 'Nama Perusahaan') ?>" id="prefix_name" class="form-control">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select data-validation-error-msg="Bidang Usaha tidak valid!." multiple name="type[]" id="type" class="form-control select2">
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <select type="select" onchange="ocCountry(this.value);" id="id_country" name="id_country" class="form-control" data-validation-error-msg="Negara tidak valid!">
                            <?php
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select type="select" onchange="ocProvince(this.value);" id="id_country_province" name="id_country_province" class="form-control select2" data-validation-error-msg="Provinsi tidak valid!">
                            <option value="">Pilih</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select type="select" id="id_city" name="id_city" class="form-control select2"  data-validation-error-msg="Kota tidak valid!">
                            <option value="">Pilih</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea type="textarea" id="address" maxlength="60" class="form-control" placeholder="Ex: Jl. Kalibesar Timur No. 5-7" name="address" data-validation="length" data-validation-length="max60" data-validation-error-msg="Alamat tidak valid!"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="pos_code" data-validation-error-msg="Kode Pos tidak valid!." class="form-control input-mask-trigger" placeholder="Ex: 11110" name="pos_code" data-validation="number length" data-validation-length="max10" data-inputmask="'mask': '99999'" inputmode="verbatim">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        <select data-validation-error-msg="Area Kerja tidak valid!." multiple name="work_area[]" id="work_area" class="form-control select2">
                            <?php
                ...
                <div class="form-group row">
                    <div class="col-md-2">
                        <label for="">Wilayah Kerja/Cabang<span style="color:red;">*</span></label></label>
                    </div>
                    <div class="col-md-10">
                        <?php $area = $this->db->where('deleted_at is null')->get(App_Model::TBL_BRANCH)->result(); ?>
                        <select data-validation-error-msg="Area Kerja tidak valid!." multiple name="cabang_area[]" id="cabang_area" class="form-control select2">
                            <?php
                            foreach ($area as $area) {
                                echo '<option value="' . $area->id . '">' . $area->name . '</option>';
                            }
                ...
                <div class="form-group row">
                    <label id="" class="col-sm-2 col-form-label">
                        No. Telepon Perusahaan<span style="color:red;">*</span>
                    </label>
                    <div class="col-sm-10">
                        <input type="text" id="phone" class="form-control input-mask-trigger" placeholder="Ex: 02123456789" name="phone" data-inputmask-regex="^[0-9]{1,15}$" inputmode="verbatim" data-validation-error-msg="No Telepon Perusahaan tidak valid!">
                    </div>
                </div>
                <div class="form-group row">
                    <label id="" class="col-sm-2 col-form-label">
                    ...
                    <div class="col-sm-10">
                        <input type="email" id="email" class="form-control" placeholder="Ex: info@bgrlogistik.id" name="email" data-validation="email" data-validation-error-msg="Email Perusahaan tidak valid!">
                    </div>
                </div>

                <div class="form-group row">
                    <label id="" class="col-sm-2 col-form-label">
                        Nilai Proyek Tertinggi<span style="color:red;">*</span>
                    </label>
                    <div class="col-sm-10">
                        <input type="text" id="highest_project_value" class="form-control input-mask-trigger" placeholder="Ex: 1000000000" name="highest_project_value" data-inputmask-regex="^[0-9]{1,1000}$" inputmode="verbatim" data-validation-error-msg="Nilai Proyek Tertinggi tidak valid!">
                    </div>
                </div>
                <!-- Company Profile -->
                <div class="row" style="margin-bottom:0px;">
                    ...
                    <div class="col-md-10">
                        <input data-validation-error-msg="File Company Profile tidak valid!" type="file" id="company_profile" name="company_profile" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf" />
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="name_pic" class="form-control" placeholder="Ex: Yudha Purnawan" name="name_pic" data-validation-error-msg="Nama Lengkap PIC tidak valid!">
                </div>
            </div>
            <div class="form-group row">
                <label id="" class="col-sm-2 col-form-label">
                    Jenis Posisi<span style="color:red;">*</span>
                </label>
                <div class="col-sm-10">
                    <select type="select" id="position_type" onchange="ocPositionType(this);" name="position_type" class="form-control" data-validation-error-msg="Jenis posisi PIC tidak valid!">
                        <option value="">Pilih</option>
                        <option value="1">Direksi/Pemilik Usaha</option>
            ...
            <div class="form-group row">
                <label id="" class="col-sm-2 col-form-label">
                    Posisi/Jabatan<span style="color:red;">*</span>
                </label>
                <div class="col-sm-10">
                    <input type="text" id="position" class="form-control" placeholder="Ex: Manager Procurement" name="position"  data-validation-error-msg="Posisi/Jabatan tidak valid!">
                </div>
            </div>
            <div class="form-group row">
                <label id="" class="col-sm-2 col-form-label">
                ...
                <div class="col-sm-10">
                    <input type="text" id="mobile_phone" class="form-control input-mask-trigger" placeholder="Ex: 081234567899" name="mobile_phone" data-validation="" data-inputmask-regex="^[0-9]{1,15}$" inputmode="verbatim" data-validation-error-msg="No Handphone PIC tidak valid!">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="email_pic" class="form-control" placeholder="Ex: example@bgrindonesia.co.id" name="email_pic" data-validation="email" data-validation-error-msg="Email PIC tidak valid!">
                </div>
            </div>
            ...
            <div class="row" style="margin-bottom:0px;">
                <div class="col-md-2">
                    <label for="">Upload Surat Kuasa<span style="color:red;" id="span_req_surat_kuasa">*</span></label>
                </div>
                <div class="col-md-10">
                    <input type="file" id="attachment_surat_kuasa" name="attachment_surat_kuasa" class="form-control" data-validation=" mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
                    <input type="hidden" name="attachment_surat_kuasa_old" id="attachment_surat_kuasa_old">
                    <a href="" style="display:none;" id="download_file_surat_kuasa" target="_blank" class="btn btn-sm btn-info">Lihat File</a>
                </div>
            </div>

            <div class="form-group row">
                <div class="col-md-2">
                    <label for="">Upload KTP Pemilik<span id="span_req_ktp" style="color:red;">*</span></label>
                </div>
                <div class="col-md-10">
                    <input type="file" id="attachment_ktp" name="attachment_ktp" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="file" id="attachment_pakta" name="attachment_pakta" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
                    <a href="" style="display:none;" id="download_file_ktp" target="_blank" class="btn btn-sm btn-info">Lihat File</a>
                    <input type="hidden" name="attachment_pakta_old" id="attachment_pakta_old" value="">
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="no_npwp" class="form-control input-mask-trigger" placeholder="NPWP" name="no_npwp" data-validation="" data-inputmask="'mask': '99.999.999.9-999.999'" inputmode="verbatim">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="file" id="attachment_npwp" name="attachment_npwp" class="form-control" data-validation=" mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
            ...
            <div class="form-group row">
                <div class="col-md-2">
                    <label for="">Upload Akta Perusahaan<span style="color:red;">*</span></label>
                </div>
                <div class="col-md-10">
                    <input type="file" id="attachment_akta" name="attachment_akta" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg, zip" />
                    <span style="color:red">File pdf, png, jpeg, jpg, zip Maksimal 50MB <br /> Mohon kirim Akta Pendirian dan Pembaruan(jika da) dalam bentuk zip</span>
                    <a href="" style="display:none;" id="download_file_akta" target="_blank" class="btn btn-sm btn-info">Lihat File</a>
                    <input type="hidden" name="attachment_akta_old" id="attachment_akta_old" value="">
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-2">
                    <label for="">Upload SIUP<span style="color:red;">*</span></label>
                </div>
                <div class="col-md-10">
                    <input type="file" id="attachment_siup" name="attachment_siup" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
                    <a href="" style="display:none;" id="download_file_siup" target="_blank" class="btn btn-sm btn-info">Lihat File</a>
                    <input type="hidden" name="attachment_siup_old" id="attachment_siup_old" value="">
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-2">
                    <label for="">Upload TDP
                        <!-- <span style="color:red;">*</span> -->
                    </label>
                </div>
                <div class="col-md-10">
                    <input type="file" id="attachment_tdp" name="attachment_tdp" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <!-- <input type="file" id="attachment_tdp" name="attachment_tdp" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" /> -->
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
                    <a href="" style="display:none;" id="download_file_tdp" target="_blank" class="btn btn-sm btn-info">Lihat File</a>
                    <input type="hidden" name="attachment_tdp_old" id="attachment_tdp_old" value="">
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-md-2">
                    <label for="">Upload NIB</label>
                </div>
                <div class="col-md-10">
                    <input type="file" id="attachment_nib" name="attachment_nib" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
                    <a href="" style="display:none;" id="download_file_nib" target="_blank" class="btn btn-sm btn-info">Lihat File</a>
                    <input type="hidden" name="attachment_nib_old" id="attachment_nib_old" value="">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="file" id="attachment_imb" name="attachment_imb" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="file" id="attachment_tdg" name="attachment_tdg" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
            ...
            <div class="form-group row">
                <div class="col-md-2">
                    <label for="">Upload Surat Keterangan Domisili<span id="span_req_domisili" style="color:red;">*</span></label>
                </div>
                <div class="col-md-10">
                    <input type="file" id="attachment_domisili" name="attachment_domisili" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
                    <a href="" style="display:none;" id="download_file_domisili" target="_blank" class="btn btn-sm btn-info">Lihat File</a>
                    <input type="hidden" name="attachment_domisili_old" id="attachment_domisili_old" value="">
                </div>
            </div>
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" id="no_rekening" class="form-control" placeholder="No.Rekening" name="no_rekening" data-validation="required" data-inputmask-regex="^[0-9]{1,15}$" data-validation-error-msg="No.Rekening tidak valid!">
                </div>
            </div>
            ...
            <div class="row" style="margin-bottom:0px;">
                <div class="col-md-2">
                    <label for="">Buku Tabungan
                        <!-- <span id="span_req_bank" style="color:red;">*</span> -->
                    </label>
                </div>
                <div class="col-md-10">
                    <input type="file" id="attachment_bank" name="attachment_bank" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            <div class="form-group row">
                <div class="col-md-2">
                    <label for="">Laporan Keuangan 1 Tahun Terakhir
                        <!-- <span id="span_req_fin_report_1y" style="color:red;">*</span> -->
                    </label>
                </div>
                <div class="col-md-10">
                    <input type="file" id="attachment_fin_report_1y" name="attachment_fin_report_1y" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <!-- <input type="file" id="attachment_fin_report_1y" name="attachment_fin_report_1y" class="form-control" data-validation="required mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" /> -->
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
    ...
    <div class="main-card mb-3 card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="file" id="attachment_kebijakan_k3" name="attachment_kebijakan_k3" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="file" id="attachment_tanggap_darurat" name="attachment_tanggap_darurat" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="file" id="attachment_iso_450001" name="attachment_iso_450001" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="file" id="attachment_stuktur_organisasi_k3" name="attachment_stuktur_organisasi_k3" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input type="file" id="attachment_peralatan_k3" name="attachment_peralatan_k3" class="form-control" data-validation="mime size" data-validation-max-size="50M" data-validation-allowing="pdf, png, jpeg, jpg" />
                    <span style="color:red">File pdf, png, jpeg, jpg, Maksimal 50MB</span>
...
<script>
    $(document).ready(function() {
        ...
        $('#prefix_name').change(function() {
            $('#name').val("");
            var val = $(this).val();
            var currentName = `${$('#prefix_name').val()} ${$('#name').val()}`;
            var maxLength = 40 - currentName.length;
            $('#name').attr('maxlength', maxLength);
            $('#system-name-note').html(`Karakter Tersedia ${maxLength} karakter. <b>${currentName}</b>`);
        });

        $('#name').keyup(function() {
            var currentName = `${$('#prefix_name').val()} ${$('#name').val()}`;
            var maxLength = 40 - currentName.length;
            $('#system-name-note').html(`Kareter Tersedia ${maxLength} karakter. <b>${currentName}</b>`);
        });
        ...
        $.validate({
            ...
            onSuccess: function($form) {
                ...
                formURL += 'required_info/edit_data_profile_dashboard';
            ...
            success: function(res) {
                ...
                if (pic != null && Object.keys(pic).length > 0) {
                    ...
                    if (pic.attachment != null) {
                        ...
                        if (pic.position_type == "1") {
                            $('#attachment_surat_kuasa').attr('data-validation', 'mime size');
                            $('#span_req_surat_kuasa').css('display', 'none');
                        } else if (pic.position_type == "2") {
                            // $('#attachment_surat_kuasa').attr('data-validation', 'required mime size');
                            $('#span_req_surat_kuasa').css('display', '');
                        }
                    }
                ...
                if (fin_report_1y != null && Object.keys(fin_report_1y).length > 0) {
                    ...
                    if (fin_report_1y.attachment != null) {
                        ...
                        // $('#attachment_fin_report_1y').attr('data-validation', 'required mime size');
                ...
                //Domisili
                if (domisili != null && Object.keys(domisili).length > 0) {
                    $("#action_domisili").val("edit");
                    if (domisili.attachment != null) {
                        $('#attachment_domisili').attr('data-validation', 'mime size');
                        $('#span_req_domisili').css('display', 'none');
                        $('#attachment_tdg_domisili').val(domisili.attachment);
                        $("#download_file_domisili").attr('href', site_url + '/upload/company/file/' + domisili.attachment);
                        $("#download_file_domisili").css('display', '');
                    } else {
                        // $('#attachment_domisili').attr('data-validation', 'required mime size');
                        $('#span_req_domisili').css('display', '');
                        $('#attachment_domisili_old').val('');
                        $("#download_file_domisili").css('display', 'none');
                    }
                } else {
                    $("#action_domisili").val("add");
                }
                ...
                var cabang_areas = [];
                if (res.cabang_area != null) {
                    res.cabang_area.forEach(function(e) {
                        cabang_areas.push(e.id_cabang);
                    });
                }

                $('#work_area').val(work_areas).trigger('change');
                $('#cabang_area').val(cabang_areas).trigger('change');

                var verification_status = `<?php $data = $this->db->where('id_user', $this->session->userdata('user')['id_user'])->get(App_Model::TBL_COMPANY_PROFILE)->row();
