...
class App extends App_Controller
{
    ...
    public function index()
    {
        ...
        if (
            ...
            $data['include_topbar'] = true;
            $data['include_sidebar'] = false;
            return template_view('templates/dashboard/body_custom', 'pages/required_info/registration_container', $data);
            // if ($this->session->userdata('user')['id_usr_role'] == App_Model::ROLE_VENDOR_PERSONAL) {
            // 	return template_view('templates/dashboard/body_custom', 'pages/required_info/registration_person', $data);
            // }else{
